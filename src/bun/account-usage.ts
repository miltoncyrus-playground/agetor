 ...
 * Purely local/historical — live limit-utilization percentages are a
 * separate concern, covered by `src/bun/usage/*`'s per-harness-kind quota
 * pollers (claude-code/codex/cursor), not this module.
 */
